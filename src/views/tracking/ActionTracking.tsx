  ...
  return (
    ...
    >
        ...
        <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            select
            defaultValue="report-user"
            >   
                <MenuItem value="report-user"><Button sx={{ color:'black' }} size="small" href='/tracking'>Report User</Button></MenuItem>
                <MenuItem value="history"><Button sx={{ color:'black' }}  size="small" href='/tracking/history'>History</Button></MenuItem>
            </TextField>
