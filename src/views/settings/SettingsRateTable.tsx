...
const rows = [
  createData('< = 1 km', 'Rp 2000'),
  createData('< = 2 km', 'Rp 4000'),
  createData('< = 3 km', 'Rp 6000'),
  createData('< = 4 km', 'Rp 8000'),
  createData('< = 5 km', 'Rp 10000'),
  createData('< = 5 km', 'Rp 12000'),
]
...
export default SettingsRateTable
